# !/usr/bin/env python3
# python FID.py C:\Users\calvchen\Downloads\stage1\Our_low\low00001.png C:\Users\calvchen\Down
# loads\stage1\Our_low\low00002.png
...
def get_activations(images, sess, batch_size=50, verbose=False):
    ...
    for i in range(n_batches):
        ...
        pred = sess.run(inception_layer, {'ExpandDims:0': batch})  # FID_Inception_Net/
