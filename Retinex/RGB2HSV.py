...
# name = 'Lighthouse_under'
name = str(5)
img=cv2.imread("../data/my_data/{}.PNG".format(name))
...
# img_S=cv2.imread("../figures/1_S.png")
# hsv_S=cv2.cvtColor(img_S,cv2.COLOR_BGR2HSV)
# hsv[:,:,2]=hsv_S[:,:,2]
rgb = cv2.cvtColor(hsv,cv2.COLOR_HSV2RGB)
plt.imshow(rgb)
plt.imshow(hsv[:,:,2],cmap="gray")
