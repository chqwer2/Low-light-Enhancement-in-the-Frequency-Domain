...
parser.add_argument('--out_dir', dest='out_dir', default='./output', help='directory for checkpoints')
parser.add_argument('--act', dest='act', default='leaky', help='one of [relu, leaky, prelu]')
parser.add_argument('--save_dir', dest='save_dir', default='./test_results', help='directory for testing outputs')
parser.add_argument('--train_dir', dest='train_dir', default='./data/train', help='directory for testing inputs')
